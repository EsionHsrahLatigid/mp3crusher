if(NOT DEFINED MP3CRUSHER_STAGED_DIR)
    message(FATAL_ERROR "MP3CRUSHER_STAGED_DIR is required")
endif()

set(vst3 "${MP3CRUSHER_STAGED_DIR}/VST3/MP3 Crusher.vst3")
if(MP3CRUSHER_EXPECT_AU)
    set(standalone "${MP3CRUSHER_STAGED_DIR}/Standalone/MP3 Crusher.app")
elseif(WIN32)
    set(standalone "${MP3CRUSHER_STAGED_DIR}/Standalone/MP3 Crusher.exe")
else()
    set(standalone "${MP3CRUSHER_STAGED_DIR}/Standalone/MP3 Crusher")
endif()
...
if(MP3CRUSHER_EXPECT_AU)
    ...
    set(au "${MP3CRUSHER_STAGED_DIR}/AU/MP3 Crusher.component")
